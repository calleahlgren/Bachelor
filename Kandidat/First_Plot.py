...
gLine2, = plt.loglog(growthTrack(0.01, 0.01, 0.02, 0.01, 25)[0],growthTrack(0.01, 0.01, 0.02, 0.01, 25)[1], 'g', label=r'($\rm \alpha$, St, $\rm \xi$)=0.01,0.01,0.02')
...
plt.savefig('Step_Int_growthTracks1.png', dpi=500)